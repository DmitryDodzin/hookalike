...
export const register = <T extends {}, U extends keyof T = keyof T>(creator: CreatorFn<T[U]> | ILoader<T, U>, deps?: Omit<keyof T, U>[]) =>  typeof creator === 'function' ? new Loader<T, U>(creator) : creator;
